...
public:
	...
	virtual const QChar* GetShortString(void)const{return NULL;}
	virtual const QChar* GetTypeString(void)const{return QString::fromAscii("Unknown",7).constData();}
	const QChar* GetShortStringOrTypeString(void)const{if(GetShortString())return GetShortString();return GetTypeString();}
	...
	virtual const QColor* GetColor()const{return NULL;}
	...
	virtual QWidget* GetDialog(QWidget* parent){return NULL;} // returns a window for editing the values of this object.
	virtual void GetOnEdit(bool(**callback)(CADObject*)){} // returns a function for doing edit with a dialog
	bool Edit(){ bool(*fn)(CADObject*) = NULL; GetOnEdit(&fn); if(fn)return (*fn)(this); else return false;}  // do edit with a dialog
	virtual void OnApplyProperties(){}
	virtual bool ValidateProperties(){return true;}
	virtual const QBitmap &GetIcon();
	virtual int Intersects(const CADObject *object, std::list< double > *rl)const{return 0;}
	...
	virtual bool CanAdd(CADObject* object){return false;}
	virtual bool CanAddTo(CADObject* owner){return true;}
	virtual bool DescendForUndo(){return true;}
	virtual bool GetSkipForUndo(){return skip_for_undo;}
	virtual void SetSkipForUndo(bool val){skip_for_undo = val;}
	...
	virtual bool IsDifferent(CADObject* other){return false;}
	virtual void Remove(CADObject* object){object->OnRemove();}
	virtual void OnAdd(){}
	virtual void OnRemove();
	virtual bool CanBeRemoved(){return true;}
	virtual bool CanBeCopied(){return true;}
	virtual CADObject* GetFirstChild(){return NULL;}
	virtual CADObject* GetNextChild(){return NULL;}
	virtual CADObject* GetAtIndex(int index){return NULL;}
	virtual int GetNumChildren(){return 0;}
	virtual std::list<CADObject *> GetChildren() const { std::list<CADObject *> empty; return(empty); }
